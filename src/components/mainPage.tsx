      ...
      <main>
        <div>
          ...
          <div className="footer">
            ...
            To browse and test the internal API, click here for <a href={"/swagger/menuapi/"} target="_blank">Menu API</a> and <a href={"/swagger/orderapi/"} target="_blank">Order API</a>.
          </div>
        </div>
      </main >
    );
